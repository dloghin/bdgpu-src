#!/bin/bash
#
# Set common variables for Hadoop benchmarks on Intel Core i7
#
...
# CUDA (6.0) on i7
export CUDA_LIBS="/usr/local/cuda-6.0/lib64/libcudart.so,/usr/local/cuda-6.0/lib64/libcudart.so.6.0,/usr/local/cuda-6.0/lib64/libcudart.so.6.0.26"
